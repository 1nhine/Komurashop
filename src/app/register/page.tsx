    ...
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="p-8 rounded-3xl bg-slate-900 border border-slate-800 shadow-2xl">
        <div className="text-center mb-6">
          ...
          <p className="text-xs text-slate-400 mt-1">Đăng ký thành viên để nạp ví và nhận ưu đãi</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-xs font-semibold text-slate-300 block mb-1">Họ và tên / Biệt danh</label>
            <input
              type="text"
              required
